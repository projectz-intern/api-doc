...
toc_footers:
  ...
  - <a href='https://github.com/slatedocs/slate'>Documentation by ProjectZ</a>
...
Sample code is available for reference in Shell, Ruby, Python and Javascript.
The Java code requires the Unirest library. The Python code requires the Unirest
and Json libraries.

To integrate the OCRAN Enterprise API with your application, check out the
[Getting Started] section in upcoming release for a step-by-step guide and 
workflow overview.
...
Then in return, the user gets the json in response
...
`GET http://34.237.91.236/get_imageurl`
...
|---------------|----------------------|
|Http Request|'POST'|
|URL|http://34.237.91.236/get_imageurl|
